...
public class Dentist6 extends PersonBase implements Identifiable, Printable, Saveable, Schedulable {

    private String specialization;
    private int yearsOfExperience;

    public Dentist6(String fullName, int idNumber, String phoneNumber, String email,
